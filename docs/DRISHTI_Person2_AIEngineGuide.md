...
```
language values: `"en"` for English, `"kn"` for Kannada
...
```json
{
  ...
  "needs_data": null,
  "confidence": 0.94,
  "data_sources": ["Catalyst Data Store — FIRs table", "NCRB 2023 Karnataka"],
...
4. **Test the fix** before moving on
5. **If still stuck**: message Vedesh with the error + what you tried. He escalates.

---

*DRISHTI — ದೃಷ್ಟಿ | Person 2 AI Engine Guide | KSP × Hack2Skill 2026*
