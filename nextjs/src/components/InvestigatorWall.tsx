...
export default function InvestigatorWall({
  ...
  if (isLoading) {
    return (
      <div className="w-full rounded-2xl bg-steel-700 border border-steel-600 p-8 min-h-[700px] flex flex-col justify-center items-center gap-4">
        <div className="animate-pulse flex flex-col items-center gap-4 w-full max-w-4xl">
          ...
          <div className="h-4 bg-steel-600 rounded w-1/2 mt-2" />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-10">
            <div className="h-80 bg-steel-600/50 rounded-xl" />
            <div className="h-96 bg-steel-600/80 rounded-xl" />
            <div className="h-80 bg-steel-600/50 rounded-xl" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="lg:col-span-1 flex flex-col gap-4">
          <div className="flex items-center justify-between px-1">
            ...
            <div className="h-px bg-steel-600/40 flex-grow ml-3" />
          </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-grow min-w-0">
                    <div className="flex items-center justify-between gap-1.5">
                      <h4 className="text-sm font-semibold text-paper-100 truncate group-hover:text-critical-500 transition-colors">
                        {item.full_name}
                      </h4>
                    ...
                    {item.alias && (
                      <p className="text-[10px] text-paper-100/60 italic">a.k.a. {item.alias}</p>
                    )}
                ...
                {item.modus_operandi && (
                  <div className="mt-2.5 pt-2 border-t border-steel-600/30">
                    ...
                    <p className="text-[10px] text-paper-100/60 italic leading-relaxed mt-0.5 line-clamp-2">
                      {item.modus_operandi}
                    </p>
                  </div>
                )}
