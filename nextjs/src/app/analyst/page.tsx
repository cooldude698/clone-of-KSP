...
import {
  ...
  Fingerprint, Clock, Radio, Scale, SlidersHorizontal
} from 'lucide-react';
...
export default function AnalystIntelligenceHub() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-6 text-slate-900 dark:text-white">
      ...
      {/* ── SPECIALIZED CRIME INTELLIGENCE WORKBENCH SUITE ── */}
      <div className="rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-6 sm:p-8 shadow-md border border-slate-700 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full bg-blue-500/20 text-blue-300 border border-blue-400/30 text-[10px] font-mono font-bold uppercase tracking-wider">
                SCRB ANALYTICAL SUITE
              </span>
              <span className="text-xs text-slate-400 font-mono">CCTNS Live Synthesis</span>
            </div>
            <h2 className="text-xl font-extrabold tracking-tight text-white mt-1">
              Crime & Intelligence Analytical Workbench
            </h2>
            <p className="text-xs text-slate-300 max-w-2xl mt-0.5">
              Deep forensic and tactical analysis tools engineered for State Intelligence and CID analysts.
            </p>
          </div>

          <Link
            href="/analyst/workbench"
            className="px-5 py-2.5 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-black transition-all flex items-center gap-2 shadow-md w-fit"
          >
        ...
        {/* 6 Quick-Access Workbench Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          
          <Link
            href="/analyst/workbench?tool=mo_linker"
            className="p-4 rounded-2xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 hover:border-blue-500/60 transition-all flex flex-col justify-between group"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-mono font-bold text-emerald-400">98.4% Precision</span>
              </div>
              <h4 className="text-xs font-bold text-white group-hover:text-blue-300 transition-colors">
                MO Linkage & Cold Case Matcher
              </h4>
              <p className="text-[11px] text-slate-400 mt-1 leading-snug">
                Cross-FIR Modus Operandi clustering, entry tool signature comparison, and series merging.
              </p>
            </div>
            <div className="flex items-center gap-1 text-[10px] font-bold text-blue-400 pt-3">
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-mono font-bold text-rose-400">⚡ Overdue 0.6d</span>
              </div>
              <h4 className="text-xs font-bold text-white group-hover:text-amber-300 transition-colors">
                24×7 Chrono Matrix & Forecaster
              </h4>
              <p className="text-[11px] text-slate-400 mt-1 leading-snug">
                Hour-by-day incident density heatmatrix with automated strike window prediction.
              </p>
            </div>
            <div className="flex items-center gap-1 text-[10px] font-bold text-amber-400 pt-3">
              <span>Inspect Strike Recurrence</span>
              <ChevronRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
            </div>
          </Link>

          <Link
            href="/analyst/workbench?tool=geo_profiling"
            className="p-4 rounded-2xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 hover:border-blue-500/60 transition-all flex flex-col justify-between group"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-mono font-bold text-purple-300">Rossmo Algorithm</span>
              </div>
              <h4 className="text-xs font-bold text-white group-hover:text-purple-300 transition-colors">
                Rossmo Geographic Profiler
              </h4>
              <p className="text-[11px] text-slate-400 mt-1 leading-snug">
                Mathematical centroid estimator calculating probable stash houses and checkpoint chokepoints.
              </p>
            </div>
            <div className="flex items-center gap-1 text-[10px] font-bold text-purple-400 pt-3">
              <span>Calculate Anchor Base</span>
              <ChevronRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
            </div>
          </Link>

          <Link
            href="/analyst/workbench?tool=telemetry_fusion"
            className="p-4 rounded-2xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 hover:border-blue-500/60 transition-all flex flex-col justify-between group"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-mono font-bold text-emerald-300">ANPR + CDR Sync</span>
              </div>
              <h4 className="text-xs font-bold text-white group-hover:text-emerald-300 transition-colors">
                Multi-Sensor Telemetry Fusion
              </h4>
              <p className="text-[11px] text-slate-400 mt-1 leading-snug">
                Timeline intersect of optical cameras, Fastag toll gates, and cell tower CDR dumps.
              </p>
            </div>
            <div className="flex items-center gap-1 text-[10px] font-bold text-emerald-400 pt-3">
              <span>Corroborate Movements</span>
              <ChevronRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
            </div>
          </Link>

          <Link
            href="/analyst/workbench?tool=ach_matrix"
            className="p-4 rounded-2xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 hover:border-blue-500/60 transition-all flex flex-col justify-between group"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-mono font-bold text-indigo-300">Heuer Doctrine</span>
              </div>
              <h4 className="text-xs font-bold text-white group-hover:text-indigo-300 transition-colors">
                ACH Hypothesis Matrix
              </h4>
              <p className="text-[11px] text-slate-400 mt-1 leading-snug">
                Analysis of Competing Hypotheses matrix to mathematically eliminate investigator bias.
              </p>
            </div>
            <div className="flex items-center gap-1 text-[10px] font-bold text-indigo-400 pt-3">
              <span>Test Competing Theories</span>
              <ChevronRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
            </div>
          </Link>

          <Link
            href="/analyst/workbench?tool=legal_dossier"
            className="p-4 rounded-2xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 hover:border-blue-500/60 transition-all flex flex-col justify-between group"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-mono font-bold text-rose-300">BNS §303 / BSA §63</span>
              </div>
              <h4 className="text-xs font-bold text-white group-hover:text-rose-300 transition-colors">
                Court Dossier & Bail Opp. Generator
              </h4>
              <p className="text-[11px] text-slate-400 mt-1 leading-snug">
                One-click official intelligence briefing with statutory mappings and electronic hash certificate.
              </p>
            </div>
            <div className="flex items-center gap-1 text-[10px] font-bold text-rose-400 pt-3">
              <span>Generate Prosecution Brief</span>
              <ChevronRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
            </div>
          </Link>
