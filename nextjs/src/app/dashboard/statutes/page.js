            ...
            >
              ...
              <div className="space-y-1.5 pr-6">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-mono text-xs font-semibold px-2 py-0.5 rounded bg-indigo-50 text-indigo-700 dark:bg-indigo-950/60 dark:text-indigo-300">
                    {activeStatuteModal.bnsSection}
                  </span>
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${activeStatuteModal.bailable ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300' : 'bg-rose-50 text-rose-700 dark:bg-rose-950 dark:text-rose-300'}`}>
              ...
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200/80 dark:border-zinc-700/80 space-y-1 text-xs">
                <p className="font-bold text-slate-700 dark:text-slate-300 uppercase text-[10px] tracking-wider">Arrest & BNSS Procedure</p>
              ...
              <div className="space-y-1.5">
                ...
                <div className="space-y-1">
                  {activeStatuteModal.essentialIngredients.map((item, i) => (
                    <div key={i} className="flex items-start gap-2 p-2 rounded-lg bg-slate-50 dark:bg-zinc-800/50 text-[11px] text-slate-700 dark:text-slate-300 border border-slate-100 dark:border-zinc-800">
              ...
              <div className="space-y-1.5">
                ...
                <div className="space-y-1">
                  {activeStatuteModal.investigationChecklist.map((step, i) => (
                    <div key={i} className="flex items-start gap-2 p-2 rounded-lg bg-indigo-50/30 dark:bg-indigo-950/20 text-[11px] text-slate-700 dark:text-slate-300 border border-indigo-100/50 dark:border-indigo-900/40">
                      <span className="text-indigo-600 dark:text-indigo-400 font-bold text-[11px]">✓</span>
                      <span>{step}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="p-3 rounded-xl bg-amber-50/60 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-900/40 space-y-1 text-xs">
                <p className="font-bold text-amber-800 dark:text-amber-300 uppercase text-[10px] tracking-wider">Landmark Judicial Precedent</p>
              ...
              <div className="pt-2 border-t border-slate-200 dark:border-zinc-800 flex justify-between items-center">
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-slate-300 text-xs font-semibold hover:bg-slate-200 dark:hover:bg-zinc-700 transition flex items-center gap-1.5"
                >
