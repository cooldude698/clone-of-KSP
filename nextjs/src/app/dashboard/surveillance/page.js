...
const MOCK_CAMERAS = [
  {
    ...
    video_url: '/videos/car-detection.mp4',
  ...
  },
  {
    ...
    has_anpr: true,
    has_face_recog: true,
    video_url: '/videos/face-walking.mp4',
  ...
  },
  {
    ...
    has_anpr: true,
    has_face_recog: false,
    video_url: '/videos/person-bicycle-car.mp4',
  ...
  },
  {
    ...
    has_anpr: false,
    has_face_recog: false,
    video_url: '/videos/store-cctv.mp4',
  ...
  },
  {
    ...
    has_anpr: true,
    has_face_recog: true,
    video_url: '/videos/face-pose.mp4',
