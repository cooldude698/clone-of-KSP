            ...
            >
              ...
              <div className="space-y-1 pr-8 border-b border-slate-100 dark:border-zinc-800 pb-3">
                ...
                <p className="text-[11px] text-slate-500">
                  {activeModalUnit.court} · {activeModalUnit.jurisdictionArea}
                </p>
              </div>

              {/* 2-Column Wide Content Layout */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Left Column: Comms & Crime Profile */}
                <div className="space-y-3">
                  ...
                  {/* Crime Breakdown */}
                  <div className="space-y-1.5 p-3 rounded-xl bg-slate-50 dark:bg-zinc-800/50 border border-slate-100 dark:border-zinc-800">
                    <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1">
                      <FileText className="w-3.5 h-3.5 text-indigo-500" />
                      FIR Case Breakdown ({activeModalUnit.casesTotal} Total)
                    </h4>
                ...
                {/* Right Column: Fleet & Commissioned Officers */}
                <div className="space-y-3">
                  {/* Fleet & Mobile Units */}
                  <div className="space-y-1.5">
                    <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1">
